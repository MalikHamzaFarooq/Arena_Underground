       ...
       >
        ...
        <Grid container sx={{ display: "flex", flexDirection: "row" }}>
            ...
            >
              <Typography
                variant="h6"
                sx={{ marginTop: "8%", color: "#999999", lineHeight: 1, textAlign:'center', }}
              >
                Welcome to
              </Typography>
              <Typography
                variant="h4"
                sx={{ color: "#009bc9", lineHeight: 1.1, fontWeight: 400, textAlign:'center', }}
              >
                Wheatley & Co Chartered Accountants
              </Typography>
              <Typography
                variant="body1"
                sx={{
